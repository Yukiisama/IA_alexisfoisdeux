...
#########GLOBALS##############
##tab_greed = [1,1,1,1,1,1,0,1]#
##tab_early = [1,1,1,1,1,0,0,0]#
##tab_mid   = [3,1,1,1,1,0,1,1]#
##tab_late =  [1,3,1,0,1,1,3,3]#
tab_greed = [0,0,0,  2,1/10,0,2,1]#
tab_early = [1/4,0,0,2,1/10,0,0,1]#
tab_mid   = [1/4,0,0,2,1/10,1/4,1,0]#
tab_late =  [1/4,0,0,2,1/10,1/4,1,0]
                             #
nbmove = 0                   #
MAX = 10000000               #
MIN =-10000000               #
...
def NegaBeta(self,b,depths,moves):
    ...
    for depth in range(3,self._maxdepth):
        print("depth :",depth)
        print("Time :",time.time()-self._start)
...
class myPlayer(PlayerInterface):
    ...
    def getPlayerMove(self):
        ...
        if  (len(moves)==0): return (-1,-1)
            ...
            if  (nbmove <  60):  move = NegaBeta(self,self._board,3,moves)#Nega(self._board, self, 3, MIN, MAX,1,moves)
            elif(nbmove >= 60):  move = NegaBeta(self,self._board,coeff_mid,moves)#Nega(self._board, self, 3, MIN, MAX,1,moves)
